      ...
      <div className="relative max-w-6xl mx-auto grid md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-1">
          ...
          <div className="flex gap-4 mt-6">
            <a
              href="https://www.facebook.com/p/We-Are-Digital-61557367010278/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 flex items-center justify-center rounded-full bg-white/10 border border-white/20 text-gray-300 hover:text-white hover:bg-purple-600/30 transition"
            >
            ...
            <a
              href="https://www.instagram.com/we_are_digital1/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 flex items-center justify-center rounded-full bg-white/10 border border-white/20 text-gray-300 hover:text-white hover:bg-pink-500/30 transition"
            >
            ...
            <div className="w-9 h-9 flex items-center justify-center rounded-full bg-white/10 border border-white/20 text-gray-600 cursor-not-allowed" title="Coming soon">
